  ...
  try {
    ...
    const options = orderedSongIds.map((songId, i) => {
      ...
      return {
        ...
        difficulty: song ? song.difficulty : null,
        risk: song ? song.risk : null,
        baseVocal: song ? song.baseVocal : null,
        baseDance: song ? song.baseDance : null,
        mainAttribute: song ? song.mainAttribute : null,
        index: i,
