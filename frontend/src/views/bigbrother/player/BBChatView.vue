...
import { bbGetChatMessages, bbSendChatMessage } from '../../../services/bbApi'
...
<style scoped>
.bb-chat-player { max-width: 800px; margin: 0 auto; display: flex; flex-direction: column; height: calc(100vh - 120px); }
...
.bb-btn { background: transparent; border: 1px solid #00ff8844; color: #00ff88; padding: 10px 24px; border-radius: 6px; cursor: pointer; font-size: 14px; transition: all 0.2s; }
