...
const API_BASE: string = (import.meta as any).env?.VITE_API_BASE || 'https://luck-stage-backend.onrender.com/api'
...
export function getAvatarUrl(avatar: string | null | undefined): string | undefined {
  ...
  const base = (import.meta as any).env?.VITE_API_BASE || 'https://luck-stage-backend.onrender.com/api'
